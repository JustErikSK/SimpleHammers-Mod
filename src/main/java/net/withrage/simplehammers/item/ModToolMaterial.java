...
public class ModToolMaterial {
    ...
    public static final Tier WOOD = new Tier() {
        @Override public int getUses() { return SimpleHammersConfig.woodenDurability; }
    ...
    public static final Tier STONE = new Tier() {
        @Override public int getUses() { return SimpleHammersConfig.stoneDurability; }
        @Override public float getSpeed() { return 6.0F; }
        @Override public float getAttackDamageBonus() { return 1.0F; }
    ...
    public static final Tier COPPER = new Tier() {
        @Override public int getUses() { return SimpleHammersConfig.copperDurability; }
        @Override public float getSpeed() { return 6.0F; }
        @Override public float getAttackDamageBonus() { return 1.0F; }
    ...
    public static final Tier GOLD = new Tier() {
        @Override public int getUses() { return SimpleHammersConfig.goldenDurability; }
        @Override public float getSpeed() { return 6.0F; }
        @Override public float getAttackDamageBonus() { return 1.0F; }
    ...
    public static final Tier IRON = new Tier() {
        @Override public int getUses() { return SimpleHammersConfig.ironDurability; }
        @Override public float getSpeed() { return 6.0F; }
    ...
    public static final Tier EMERALD = new Tier() {
        @Override public int getUses() { return SimpleHammersConfig.emeraldDurability; }
    ...
    public static final Tier DIAMOND = new Tier() {
        @Override public int getUses() { return SimpleHammersConfig.diamondDurability; }
    ...
    public static final Tier NETHERITE = new Tier() {
        @Override public int getUses() { return SimpleHammersConfig.netheriteDurability; }
