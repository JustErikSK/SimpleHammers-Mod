...
public class ModToolMaterial {
    ...
    public static final ToolMaterial WOOD = new ToolMaterial() {
        @Override public int getDurability() { return SimpleHammersConfig.woodenDurability; }
    ...
    public static final ToolMaterial STONE = new ToolMaterial() {
        @Override public int getDurability() { return SimpleHammersConfig.stoneDurability; }
        @Override public float getMiningSpeedMultiplier() { return 6.0F; }
        @Override public float getAttackDamage() { return 1.0F; }
    ...
    public static final ToolMaterial COPPER = new ToolMaterial() {
        @Override public int getDurability() { return SimpleHammersConfig.copperDurability; }
        @Override public float getMiningSpeedMultiplier() { return 6.0F; }
        @Override public float getAttackDamage() { return 1.0F; }
    ...
    public static final ToolMaterial GOLD = new ToolMaterial() {
        @Override public int getDurability() { return SimpleHammersConfig.goldenDurability; }
        @Override public float getMiningSpeedMultiplier() { return 6.0F; }
        @Override public float getAttackDamage() { return 1.0F; }
    ...
    public static final ToolMaterial IRON = new ToolMaterial() {
        @Override public int getDurability() { return SimpleHammersConfig.ironDurability; }
        @Override public float getMiningSpeedMultiplier() { return 6.0F; }
    ...
    public static final ToolMaterial EMERALD = new ToolMaterial() {
        @Override public int getDurability() { return SimpleHammersConfig.emeraldDurability; }
    ...
    public static final ToolMaterial DIAMOND = new ToolMaterial() {
        @Override public int getDurability() { return SimpleHammersConfig.diamondDurability; }
    ...
    public static final ToolMaterial NETHERITE = new ToolMaterial() {
        @Override public int getDurability() { return SimpleHammersConfig.netheriteDurability; }
